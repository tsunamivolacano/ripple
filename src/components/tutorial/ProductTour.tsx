...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    subtitle: 'Header Selector',
    description: 'Switch between Coach (gentle), Standard (balanced), and Doomsday (high urgency) framing to match your focus level.',
...
export const ProductTour: React.FC<ProductTourProps> = ({ onTabChange }) => {
  ...
  // Sync tab with step target and locate element
  useEffect(() => {
    ...
    const updateRect = () => {
      ...
      // Fallback selector for gauge or task card if specific one isn't present
      ...
      >
        ...
        <div className="pt-2 border-t border-slate-800 flex items-center justify-between">
          <Button
            variant="ghost"
            size="sm"
            onClick={closeTutorial<dyad-write path="src/components/tutorial/ProductTour.tsx" description="Complete interactive Product Tour component with SVG spotlight cutout and floating popover tooltips">
